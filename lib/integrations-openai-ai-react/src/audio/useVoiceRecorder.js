...
function getSupportedMimeType() {
    for (var _i = 0, PREFERRED_MIME_TYPES_1 = PREFERRED_MIME_TYPES; _i < PREFERRED_MIME_TYPES_1.length; _i++) {
        var mimeType = PREFERRED_MIME_TYPES_1[_i];
    ...
    var stopRecording = (0, react_1.useCallback)(function () {
        return new Promise(function (resolve) {
            ...
            recorder.onstop = function () {
                var _a, _b;
                var blobType = (_b = (_a = mimeTypeRef.current) !== null && _a !== void 0 ? _a : recorder.mimeType) !== null && _b !== void 0 ? _b : "audio/webm";
                var blob = new Blob(chunksRef.current, { type: blobType });
